...
structure SimprexEnvInterp = struct
  ...
  (* Evaluation tests *)
  val evalTestCases = [
      ("../ps7/expt.spx", [([2,3],8),([3,2],9),([2,5],32),([5,2],25)]),
      ("../ps7/fact.spx", [([1],1),([2],2),([3],6),([4],24),([5],120)]), 
      ("../ps7/sos.spx", [([1],1),([2],5),([3],14),([4],30),([5],55)]),
      ("../ps7/sub.spx", [([0],0),([1],1),([2],1),([3],2),([4],2),([5],3)]),
      ("../ps7/horner.spx", [([2,0],2),([2,1],3),([2,2],4),([2,3],5),([2,4],6),([2,5],7),([3,0],3),([3,1],6),([3,2],11),([3,3],18),([3,4],27),([3,5],38),([4,0],4),([4,1],10),([4,2],26),([4,3],58),([4,4],112),([4,5],194)]),
      ("../ps7/poly.spx", [([0,1],1),([1,1],2),([2,1],3),([3,1],4),([4,1],5),
...
end (* end structure SimprexEnvInterp *)

fun testEval() = SimprexEnvInterp.testEval();
